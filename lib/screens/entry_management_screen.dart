  ...
  Future<bool> _confirmApproveEntry(ShiftEntryModel entry) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Approve the entry for ${formatDateLabel(entry.date)}? Once approved, the date cannot be changed and managers cannot edit it.',
        ),
        actions: [
          TextButton(
  ...
  Future<void> _showEntryDetails(ShiftEntryModel entry) async {
    ...
    await showModalBottomSheet<void>(
      ...
      builder: (context) => EntryDetailSheet(
        ...
        showCreditCollections: true,
        showProfitInSettlement: false,
      ),
    );
  }
