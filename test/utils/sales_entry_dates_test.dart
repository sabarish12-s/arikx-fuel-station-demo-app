...
import 'package:rk_fuels/utils/sales_entry_dates.dart';

void main() {
  group('resolveDefaultSalesEntryDate', () {
    test('returns today when there are no entries', () {
      expect(
        resolveDefaultSalesEntryDate(
          const [],
    ...
    test('ignores invalid and empty dates', () {
      expect(
        resolveDefaultSalesEntryDate(
          const ['', 'not-a-date', '2026-02-30', '2026-04-08'],
          today: DateTime(2026, 4, 11),
        ),
        '2026-04-09',
      );
    ...
    test('ignores older gaps and uses the latest entry only', () {
      expect(
        resolveDefaultSalesEntryDate(
          const ['2026-04-01', '2026-04-03', '2026-04-09'],
          today: DateTime(2026, 4, 11),
        ),
        '2026-04-10',
      );
